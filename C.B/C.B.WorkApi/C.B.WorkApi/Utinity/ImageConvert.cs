...
namespace C.B.WorkApi.Utinity
{
    ...
    {
        //图片宽度，单位 px
        private readonly int imageMaxWidth = ConfigManager.ImageMaxWidth;
        //图片大小阈值 单位 k
        private readonly int imageMaxSize = ConfigManager.ImageMaxSize;
        //图片压缩比例1-100
        private readonly int imageQuality = ConfigManager.ImageDefaultQuality;
